...
//this will send a 6 digit code to the phone number via sms using twilio. - done
//
//
//            /api/v1/users/{userId}/phones/{phoneId}/completeVerification
//this will accept the 6 digit code in the request body. if it matches the value sent out in the previous request, the phone number will be marked as verified. - done
//
//
